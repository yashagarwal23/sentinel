...
class Ui_MainWindow(object):
    def creatingTables(self):
        ...
        self.tableWidget.setHorizontalHeaderLabels(["File"])
    ...
    def setupUi(self, MainWindow):
        ...
        self.output = requests.post('http://'+URL+'/getSuspectFiles').json()
        print(self.output)
        self.fileArray = self.output["files"]
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(240, 550, 201, 41))
        self.pushButton_2.setObjectName("pushButton_2")
        self.pushButton_3 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_3.setGeometry(QtCore.QRect(470, 550, 201, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Suspected Files"))
    ...
    def deleteFile(self):
        requests.post('http://' + URL + '/deleteFile', {'filepath': self.fileArray[self.selectedRow]})


if __name__ == "__main__":
    app = QtWidgets.QApplication(['suspectedFiles.py'])
